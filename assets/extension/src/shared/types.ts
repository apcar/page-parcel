...
/** Capture modes offered in the popup. */
export type CaptureMode = 'pack' | 'full-page' | 'visible' | 'region';
...
export type PopupMessage = CaptureProgress | CaptureComplete | PackComplete | CaptureError;
