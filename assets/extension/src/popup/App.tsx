...
const MODES: ModeDef[] = [
  {
    id: 'pack',
    icon: '📦',
    command: 'capture-trace-bundle',
    titleKey: 'modePack',
    subtitleKey: 'modePackSub',
  },
  {
    id: 'full-page',
    icon: '📄',
      ...
      <header class="header">
        {showSettings ? (
          ...
          <>
            <div class="brand">
              <ParcelMark />
              <span class="brand-name">PageParcel</span>
            </div>
            <button
              class="icon-btn"
              ...
              return (
                ...
                >
                  ...
                  <span class="mode-text">
                    ...
                    <span class="mode-sub">
                      {isBusy
                        ? (m.id === 'full-page' || m.id === 'pack') && progress != null
                  ...
                  {isBusy && (m.id === 'full-page' || m.id === 'pack') && progress != null ? (
  ...
  return (
    <span class="brand-mark" aria-hidden="true">
      ...
      >
        ...
        <path d="M15 3v4h3M4 10h16v6H4zM10 10v6M14 10v6" />
      </svg>
    </span>
  );
}
